...
export const en = {
    ...
    workplace: {
        ...
        worksites: {
            ...
            noSearchResults: 'No work sites found matching your search',
            noActiveSites: 'No active work sites found',
            noSites: 'No work sites found',
            deactivateWarning: 'Are you sure you want to deactivate "{siteName}"? This will also deactivate all positions at this site.',
        },
        positions: {
            title: 'Positions',
            add: 'Add Position',
