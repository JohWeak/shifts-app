...
export const en = {
    admin: {
        ...
        onlySuperAdminCanChangeRole: 'Only super administrators can change user roles.',
        flexibleEmployeeEditingRestricted: 'Only super administrators can edit flexible employees (employees not assigned to any work site).',
        requests: {
