module.exports = (sequelize, DataTypes) => {
    const ScheduleSettings = sequelize.define('ScheduleSettings', {
        ...
        generation_day: { type: DataTypes.ENUM('sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'), defaultValue: 'wednesday' },
        ...
        rest_calculation_method: { type: DataTypes.ENUM('fixed', 'dynamic', 'shift_based'), defaultValue: 'dynamic' },
